      ...
      <Link to={`/gardens/${garden.id}`} style={{ textDecoration: 'none', color: 'inherit' }}>
        ...
        >
          <div style={{
            ...
            {!garden.photo_url && (
              <i className="bi bi-flower2" style={{ fontSize: '2.5rem', color: 'var(--brand-secondary)', opacity: 0.3 }}></i>
            )}
            <div style={{
          ...
          <div className="card-footer bg-white border-top-0 py-2 px-3">
            <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.8rem' }}>
              ...
              <span style={{ color: 'var(--brand-accent)', fontWeight: 600 }}>{garden.available_plots} available</span>
            </div>
          </div>
        </div>
      </Link>
      ...
      {totalInvolved === 0 ? (
        <div className="text-center py-5">
          <div style={{
            ...
            backgroundColor: 'var(--brand-pale)', margin: '0 auto 20px',
          ...
          {data.organized && data.organized.length > 0 && (
            <div className="mb-5">
              <h4 className="fw-bold mb-3">
                <i className="bi bi-star me-2" style={{ color: 'var(--brand-gold)' }}></i>
            ...
            <div className="mb-5">
              ...
              <div className="row g-4">
                {data.plot_holder.map(g => (
                  <GardenCard key={g.id} garden={g} role="Plot Holder" roleColor="var(--brand-accent)" roleIcon="bi-grid-3x3-gap" />
                ))}
              </div>
            </div>
          )}
