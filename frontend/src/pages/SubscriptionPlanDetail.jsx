...
const styles = {
  ...
  infoValue: { fontSize: 14, fontWeight: 600, color: '#2d6a4f' },
  sellerCard: {
  ...
  price: { fontSize: 28, fontWeight: 700, color: '#2d6a4f', textAlign: 'center', marginBottom: 4 },
  ...
  capacityFill: { height: '100%', borderRadius: 4, background: '#40916c', transition: 'width 0.3s' },
  capacityText: { fontSize: 12, color: '#888', textAlign: 'center', marginBottom: 16 },
  subscribeBtn: {
    width: '100%', padding: '12px 0', borderRadius: 8, border: 'none',
    background: '#2d6a4f', color: '#fff', fontSize: 16, fontWeight: 600,
  ...
  previewDate: { fontSize: 13, fontWeight: 600, color: '#2d6a4f', marginBottom: 4 },
        ...
        <div style={styles.sidebar}>
          <Link to={`/profile/${plan.seller_id}`} style={{ textDecoration: 'none', color: 'inherit' }}>
            <div style={styles.sellerCard}>
              ...
              <div>
                <div style={{ fontWeight: 600, color: '#2d6a4f' }}>{plan.seller_name}</div>
                {plan.seller_rating && (
                  <div style={{ fontSize: 13, color: '#888' }}>
                    <i className="bi bi-star-fill" style={{ color: '#f59e0b' }}></i> {plan.seller_rating} ({plan.seller_review_count} reviews)
                  </div>
                )}
              </div>
            </div>
          ...
          {user && hasSubscription && !isOwner && (
            <>
              ...
              <Link
                to="/my-subscriptions"
                style={{ ...styles.subscribeBtn, display: 'block', textAlign: 'center', textDecoration: 'none', background: '#40916c' }}
              >
                Manage Subscription
              </Link>
            </>
