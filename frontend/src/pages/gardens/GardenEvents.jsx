...
export default function GardenEvents() {
  ...
  return (
    <div>
      <Link to={`/gardens/${id}`} style={{ color: '#2d6a4f', textDecoration: 'none', fontSize: '0.9rem' }}>
        <i className="bi bi-arrow-left me-1"></i> Back to {garden.name}
      </Link>

      <div className="d-flex justify-content-between align-items-center mt-3 mb-4">
        <h2 className="fw-bold mb-0" style={{ color: '#2d6a4f' }}>
          ...
          <div className="card-body p-4">
            ...
            <form onSubmit={handleCreateEvent}>
              <div className="row g-3">
                ...
                <div className="col-12">
                  <button type="submit" className="btn me-2" style={{ backgroundColor: '#2d6a4f', color: 'white' }}>
      ...
      <div className="btn-group mb-4">
        {['upcoming', 'past', 'all'].map(filter => (
          <button key={filter} className={`btn ${showFilter === filter ? 'btn-success' : 'btn-outline-success'}`}
            style={showFilter === filter ? { backgroundColor: '#2d6a4f', borderColor: '#2d6a4f' } : {}}
                    ...
                    <div key={event.id} className="col-md-6 col-lg-4">
                      <div className="card h-100" style={{
                        ...
                        <div className="card-body">
                          ...
                          <div className="mb-2">
                            <div className="small">
                              <i className="bi bi-calendar me-1" style={{ color: '#2d6a4f' }}></i>
                              {eventDate.toLocaleDateString('en-US', { weekday: 'long', month: 'long', day: 'numeric' })}
                            </div>
                            <div className="small">
                              <i className="bi bi-clock me-1" style={{ color: '#2d6a4f' }}></i>
                          ...
                          <div style={{
                            ...
                            {spotsLeft !== null && (
                              <span style={{ color: spotsLeft <= 3 ? '#dc3545' : '#6b7280' }}>
                          ...
                          <div className="card-footer bg-white" style={{ borderTop: '1px solid #f0f0f0', padding: '12px 16px' }}>
                            <div className="d-flex gap-2">
                              <button
                                ...
                                style={event.user_rsvp === 'going' ? { backgroundColor: '#40916c', borderColor: '#40916c' } : {}}
