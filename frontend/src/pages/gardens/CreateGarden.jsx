...
export default function CreateGarden() {
  ...
  return (
    <div style={{ maxWidth: '700px', margin: '0 auto' }}>
      <Link to="/gardens" style={{ color: '#2d6a4f', textDecoration: 'none', fontSize: '0.9rem' }}>
        <i className="bi bi-arrow-left me-1"></i> Back to Gardens
      </Link>

      <h2 className="fw-bold mt-3 mb-4" style={{ color: '#2d6a4f' }}>
              ...
              <div className="row g-2">
                {[
                  ...
                  <div key={model.value} className="col-md-4">
                    ...
                    >
                      <i className={`bi ${model.icon}`} style={{ fontSize: '1.5rem', color: '#2d6a4f' }}></i>
