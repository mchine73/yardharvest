...
const styles = {
  ...
  cardBody: { padding: 16 },
  cardTitle: { fontSize: 18, fontWeight: 600, color: '#2d6a4f', margin: '0 0 4px' },
  ...
  price: { fontSize: 20, fontWeight: 700, color: '#2d6a4f' },
  ...
  pageBtn: {
    padding: '8px 14px', borderRadius: 8, border: '1px solid #40916c',
    background: '#fff', color: '#40916c', cursor: 'pointer', fontSize: 14,
  },
  pageBtnActive: {
    padding: '8px 14px', borderRadius: 8, border: '1px solid #2d6a4f',
    background: '#2d6a4f', color: '#fff', cursor: 'pointer', fontSize: 14,
  },
  pageBtnDisabled: {
            ...
            >
              ...
              <div style={styles.cardBody}>
                ...
                <div style={styles.cardSeller}>
                  ...
                  {plan.seller_rating && (
                    <span className="ms-2">
                      <i className="bi bi-star-fill" style={{ color: '#f59e0b', fontSize: 12 }}></i> {plan.seller_rating}
                    </span>
                  )}
                </div>
