                  ...
                  {notifOpen && (
                    <div style={{
                      ...
                      <div style={{
                        ...
                        {notifCount > 0 && (
                          <button onClick={handleMarkAllRead} style={{ background: 'none', border: 'none', color: 'var(--brand-primary)', fontSize: '0.8rem', cursor: 'pointer' }}>
                            Mark all read
                          </button>
                        )}
                      </div>
                      <div style={{ maxHeight: '360px', overflowY: 'auto' }}>
                        {notifLoading ? (
                          ...
                          <div
                            ...
                            onMouseEnter={e => e.currentTarget.style.backgroundColor = n.is_read ? '#f9f9f9' : 'var(--brand-border)'}
                            onMouseLeave={e => e.currentTarget.style.backgroundColor = n.is_read ? '#fff' : 'var(--brand-pale)'}
                          >
                            <div style={{ display: 'flex', gap: '10px', alignItems: 'flex-start' }}>
                              ...
                              {!n.is_read && <div style={{ width: 8, height: 8, borderRadius: '50%', backgroundColor: 'var(--brand-primary)', marginTop: '6px', flexShrink: 0 }}></div>}
                            </div>
                          </div>
                        ))}
                      </div>
